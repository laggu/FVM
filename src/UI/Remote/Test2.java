...
public class Test2 extends JPanel {
	...
	public Test2(JFrame frame) {
		frame.setResizable(false); // 크기 변화 사용 여부
		this.init();
		frame.setResizable(false); // 크기 변화 사용 여부
		this.start();
	...
	public void init() {
		...
		node2 = new DefaultMutableTreeNode("미국");
		...
		jp3_1.setBorder(new TitledBorder(new SoftBevelBorder(SoftBevelBorder.RAISED), "개인 정보 확인"));
		jp3_1.add(button3_1);
		jp3_1.add(button3_2);
		jp3.add(jp3_1);
